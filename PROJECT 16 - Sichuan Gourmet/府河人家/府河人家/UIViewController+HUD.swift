...
extension UIViewController
{
     ...
     */
    func showHudInView(_ view: UIView, hint: String, yOffset:CGFloat?){
    ...
    /**
     ...
     - parameter yOffset: y上的偏移量
     */
    func showHint(_ hint: String, duration: Double?, yOffset:CGFloat?) {
        let view = KeyWindow
        let HUD = MBProgressHUD(view: view)
        view.addSubview(HUD)
    ...
    /**
     ...
     - parameter yOffset: y上的偏移量
     */
    func showHint(_ view: UIView, hint: String, duration: Double?, yOffset:CGFloat?) {
        let HUD = MBProgressHUD(view: view)
        view.addSubview(HUD)
        HUD.isUserInteractionEnabled = false
        HUD.mode = .text
